## Source: Conference — Day 2 (Leadership Track)



### **Post 1: Beyond the Code: People-Centric Leadership for Technical Projects**
...
* Projects often fail not due to technical issues, but due to human factors, as evidenced by a 1987 London Stock Exchange project that was abandoned after six years and spending $\text{\textsterling}400$ million.
...
### **Post 2: How to Build a CFO-Worthy Business Case for Network Automation**
...
### **Post 3: Don’t Start Somewhere - A Methodical Approach to Network Automation**
...
### **Post 4: Case Study: Building an Enterprise Automation Platform in Banking**
