## Source: Conference — Day 3 (Closing Notes)

### **Post 1: The NetDevOps Journey: Manual Firefighting to Agentic Autonomy**
[Source: Conference — Day 3 (Closing Notes)]
...
* **Scale:** Over $340,000$ miles of global fiber and $350 \text{ Tbps}$ of global backbone capacity.
...
### **Post 2: The Secret to Network Config & Security Compliance at Scale**
[Source: Conference — Day 3 (Closing Notes)]
[Post Type: LinkedIn Session Announcement]
...
### **Post 3: Using AI to Build a Network Supporting AI**
[Source: Conference — Day 3 (Closing Notes)]
[Post Type: LinkedIn Session Announcement]
...
2.  **RAG (Retrieval-Augmented Generation):** Solves the LLM hallucination problem. RAG uses a **vector database** of domain-specific information (enterprise and vendor-specific data) to ground the foundation model.
    * *Chunk Size Note:* The optimal chunk size for RAG content is between $2 \text{K}$ and $3 \text{K}$.
...
### **Post 4: Crossing the Chasm with Gluware**
[Source: Conference — Day 3 (Closing Notes)]
[Post Type: LinkedIn Session Announcement]
...
### **Post 5: Why Haven’t We Seen Full Adoption of Network Automation Yet?**
[Source: Conference — Day 3 (Closing Notes)]
[Post Type: LinkedIn Session Announcement]
