## Source: Conference — Day 2 (General Track)

### **Post 1: eBay’s Custom Orchestration Platform: Spectron**
[Source: Conference — Day 2 (General Track)]
...
* **Layered Provisioning:** Facilitates data center provisioning in stages: Layout $\rightarrow$ IP addressing $\rightarrow$ Routing details $\rightarrow$ Platforms.
...
### **Post 2: Kubernetes Network Emulation (KNE) Project**
[Source: Conference — Day 2 (General Track)]
[Post Type: LinkedIn Session Announcement]
...
### **Post 3: H-E-B's Automation Journey: From Zero to IaC**
[Source: Conference — Day 2 (General Track)]
[Post Type: LinkedIn Session Announcement]
...
### **Post 4: Autonomy vs. Automation: The Next Frontier**
[Source: Conference — Day 2 (General Track)]
[Post Type: LinkedIn Session Announcement]
...
### **Post 5: Internet2's AI Troubleshooting Agents (HAWAT)**
[Source: Conference — Day 2 (General Track)]
[Post Type: LinkedIn Session Announcement]
...
### **Post 6: USAA's Seven-Year Automation Evolution to AVD**
[Source: Conference — Day 2 (General Track)]
[Post Type: LinkedIn Session Announcement]
...
### **Post 7: The AI Inflection Point: VibeOps and Digital Coworkers**
[Source: Conference — Day 2 (General Track)]
[Post Type: LinkedIn Session Announcement]
